...
graph = Graph.from_json('/Users/carolinaferrer/Desktop/mcure/co_precincts.json')
df = gpd.read_file("/Users/carolinaferrer/Desktop/mcure/co_precincts.shp")
...
def my_uu_bipartition_tree_random(graph, pop_col, pop_target, one_sided_cut, epsilon, node_repeats=1, 
